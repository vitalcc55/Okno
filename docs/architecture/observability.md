...
3. При необходимости посмотреть соседний `report.json`, `artifacts/diagnostics/<run_id>/summary.md`, `artifacts/diagnostics/<run_id>/captures/` и `artifacts/diagnostics/<run_id>/uia/`.
