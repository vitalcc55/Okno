...
- быть нестабильным как единственный V1 backend для первого observe-loop.
...
Причина: в V1 уже есть хороший минимальный цикл из трёх tools. Новый high-level tool на этом этапе только размыл бы контракт и усложнил smoke/tests/docs.
