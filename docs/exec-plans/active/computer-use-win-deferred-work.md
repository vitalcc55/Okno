...
- Post-final review follow-up (`2026-04-26`):
  ...
  - post-review verification: targeted selector/metadata RED pack -> green `4/4`; targeted selector/freshness/metadata pack -> green `18/18`; `ComputerUseWinActionAndProjectionTests|ComputerUseWinArchitectureTests` -> green `84/84`; `ComputerUseWinInstallSurfaceTests.PublishedRuntimeBundleIsFreshReturnsFalseWhenRepoLevelBuildInputIsNewerThanManifest|ComputerUseWinInstallSurfaceTests.ComputerUseWinLauncherFromTempPluginCopyPublishesPublicSurfaceWithoutRepoHints` -> green `12/12`; broad `ComputerUseWin` contour -> green `143/143`; `McpProtocolSmokeTests` -> green `22/22`; `scripts/codex/verify.ps1` -> green, Runtime `638/638`, Server `275/275`, smoke ok, refresh-generated-docs ok.
- Deferred decisions:
