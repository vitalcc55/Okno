...
- Post-final review follow-up (`2026-04-26`):
  ...
  - post-review verification: targeted taxonomy/metadata RED pack failed as expected `3/3`, затем targeted GREEN `3/3`; `ComputerUseWinActionAndProjectionTests|ComputerUseWinArchitectureTests` -> green `86/86`; broad `ComputerUseWin` contour -> green `145/145`; `McpProtocolSmokeTests` -> green `22/22`; `scripts/codex/verify.ps1` -> green, Runtime `638/638`, Server `276/276`, smoke ok, refresh-generated-docs ok.
- Deferred decisions:
