...
public sealed class RuntimeGuardPolicyTests
{
    ...
    public void BuildWarningsReturnsDomainAndCapabilityWarningsWithoutPlaceholders()
    {
        ...
        Assert.Equal(5, warnings.Length);
        ...
        Assert.Contains(warnings, item => item.Code == GuardReasonCodeValues.InputUipiBarrierPresent);
    ...
    public void BuildCapabilitiesDerivesHealthyBaselineWithoutPlaceholders()
    {
        ...
        Assert.Equal(GuardStatusValues.Degraded, Assert.Single(capabilities, item => item.Capability == CapabilitySummaryValues.Input).Status);
        ...
        Assert.Equal(
            ...
            Assert.Single(capabilities, item => item.Capability == CapabilitySummaryValues.Input).Reasons[0].Code);
        Assert.Equal(
    ...
    [Fact]
    public void BuildCapabilitiesMarksInputUnknownWhenMediumIntegrityUiAccessFactsAreMissing()
    {
        RuntimeGuardRawFacts facts = CreateFacts(
            token: new TokenProbeResult(
                IntegrityResolved: true,
    ...
    [Fact]
    public void BuildCapabilitiesMarksInputBlockedForLowIntegrityProfile()
    {
        RuntimeGuardRawFacts facts = CreateFacts(
            token: new TokenProbeResult(
                IntegrityResolved: true,
    ...
    [Fact]
    public void BuildCapabilitiesMarksInputDegradedForMediumIntegrityWithoutUiAccess()
    {
        RuntimeGuardRawFacts facts = CreateFacts();
        ...
        Assert.Equal(GuardStatusValues.Degraded, capability.Status);
        Assert.Equal(GuardReasonCodeValues.InputUipiBarrierPresent, Assert.Single(capability.Reasons).Code);
        Assert.DoesNotContain(capability.Reasons, item => item.Code == GuardReasonCodeValues.CapabilityNotImplemented);
    }

    [Fact]
    public void BuildCapabilitiesMarksInputReadyForMediumIntegrityWithUiAccess()
    {
        RuntimeGuardRawFacts facts = CreateFacts(
            token: new TokenProbeResult(
                IntegrityResolved: true,
    ...
    [Fact]
    public void BuildCapabilitiesMarksInputReadyForHighIntegrityWithoutUiAccess()
    {
        RuntimeGuardRawFacts facts = CreateFacts(
            token: new TokenProbeResult(
                IntegrityResolved: true,
