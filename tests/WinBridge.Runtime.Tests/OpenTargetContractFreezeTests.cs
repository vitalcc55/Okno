...
public sealed class OpenTargetContractFreezeTests
{
    ...
    [InlineData(@"C:\Tools\script.py")]
    [InlineData(@"C:\Tools\script.pyc")]
    [InlineData(@"C:\Tools\script.pyw")]
    [InlineData(@"C:\Tools\archive.pyz")]
    [InlineData(@"C:\Tools\archive.pyzw")]
    [InlineData(@"C:\Tools\launcher.jar")]
