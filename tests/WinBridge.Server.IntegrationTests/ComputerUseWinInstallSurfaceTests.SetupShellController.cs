    ...
    public async Task SetupShellControllerMapsRuntimeOnlyInstallToSnippetSummaryAsync()
    {
        SetupShellController controller = new(
            () => new ComputerUseWinInstallerStatus(
                1,
                @"C:\Users\user\.codex",
                @"C:\Users\user\.codex\okno\computer-use-win",
                new ComputerUseWinRuntimeStatus(
                    1,
                    @"C:\Users\user\.codex",
                    @"C:\Users\user\.codex\okno\computer-use-win",
                    @"C:\Users\user\.codex\okno\computer-use-win\state\current-runtime.json",
                    false,
                    false,
                    false,
                    null,
            ...
            mode =>
            {
                ...
                return new ComputerUseWinInstallerResult(
                    ...
                    @"C:\Users\user\.codex",
                    @"C:\Users\user\.codex\okno\computer-use-win",
                    @"C:\Users\user\.codex\okno\computer-use-win\runtimes\win-x64\0.1.0",
                    "0.1.0",
                    "win-x64",
                    null,
                    null,
                    ...
                    false,
                    "{ \"mcpServers\": {} }",
                    @"C:\Users\user\.codex\okno\computer-use-win\receipts\runtimeonly.json",
        ...
        SetupShellController controller = new(
            ...
            mode =>
            {
                ...
                return new ComputerUseWinInstallerResult(
                    ...
                    true,
                    null,
                    @"C:\Users\user\.codex\okno\computer-use-win\receipts\codex.json",
                    DateTimeOffset.UtcNow,
                    DateTimeOffset.UtcNow);
            });
